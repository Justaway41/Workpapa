...
class DetailOfficePage extends Component {
    constructor(props) {
        super(props);
    ...
    getOfficeData = () => {
        ...
        ServiceApi.getOfficeById(params)
            .then((result) => {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(DetailOfficePage));
