                                    ...
                                    <div className="row">
                                        <div className="col-lg-12 " >
                                            ...
                                            <Table striped bordered condensed>
                                                <tbody>
                                                    {!!Object.keys(this.props.packageData.service.product).length && Object.keys(this.props.packageData.service.product).filter(item => item === this.state.selPackage.code).map(item =>
                                                        (
                                                            <tr key={item}>
                                                                <td>
                                                                    <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                        <p className="small">
                                                                            <input type="radio" name="service" disabled={false} defaultChecked={this.state.selPackage.code === item} onClick={() => { this.setSelectedPackage(item); }} value={this.props.packageData.service.product[item].code} />
                                                                            &nbsp;{this.props.packageData.service.product[item].name} {this.props.packageData.service.product[item].description ? ReactHtmlParser(`<small><i>(${this.props.packageData.service.product[item].description})</i></small>`) : ''}
                                            ...
                                            {!!Object.keys(this.state.addonData).length && this.state.addonData.filter(dat => dat.packages.indexOf(this.state.selPackage.code) !== -1).map((dat, i) =>
                                                (
                                                    <Table striped bordered condensed key={dat.title} >
                                                        <thead><tr><td><h4>{ReactHtmlParser(dat.title)}</h4></td></tr></thead>
                                                        <tbody>
                                                            {!!dat.type &&
                                                        <tr>
                                                            <td>
                                        ...
                                        <div className="col-lg-12">
                                            ...
                                            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-right">
                                                <h3>
                                                    ...
                                                    {Util.showPrice(this.props.packages.product[this.state.selPackage.code][this.state.selExperience.code] + this.state.totalPrice, this.state.conversionRate, this.state.currency, this.state.currencyCode)}
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
